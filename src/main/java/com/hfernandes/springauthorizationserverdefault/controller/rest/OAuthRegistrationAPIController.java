...
public class OAuthRegistrationAPIController {
     ...
     @RequestMapping(value = "/oauth2clients", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
     public void registerClient(@RequestBody @Valid RegisterClientInputResource registerClientInputResource) {
          LOG.info("POST:/v1/oauthregistrationapi/oauth2clients");
     ...
     @RequestMapping(value = "/oauth2resourceservers", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
     public void registerOAuth2ResourceServers(@RequestBody @Valid RegisterOAuth2ResourceServerInputResource registerOAuth2ResourceServerInputResource) {
          LOG.info("POST:/v1/oauthregistrationapi/oauth2resourceservers");
          //LOG.info("Username: {}", principal.getName());
          LOG.info("{}", registerOAuth2ResourceServerInputResource);

          oAuthRegistrationAPIOperations.registerOAuth2ResourceServer(registerOAuth2ResourceServerInputResource);
